...
export default function SimpleI18nDemo() {
  ...
  const messages = {
    en: {
      ...
      features: {
        ...
        feature1: {
          ...
          description: "Lightning-fast applications with optimized performance and instant loading"
        },
        feature2: {
          title: "Easy to Use", 
          description: "Intuitive interface designed for developers of all skill levels"
        },
        feature3: {
          title: "Scalable",
      ...
      testimonials: {
        ...
        testimonial1: {
          quote: "This platform transformed how we build applications. The speed and reliability are outstanding!",
          author: "Sarah Johnson",
          role: "Lead Developer at TechCorp"
        },
        testimonial2: {
          quote: "The best development experience I've ever had. Everything just works seamlessly.",
          author: "Miguel Rodriguez", 
          role: "Full Stack Developer"
        },
        testimonial3: {
          quote: "Our team productivity increased by 300% after switching to this platform.",
          author: "Emma Chen",
    ...
    es: {
      hero: {
        ...
        subtitle: "Desarrolla aplicaciones modernas y escalables con Next.js y las últimas tecnologías web",
        cta: "Comenzar",
        learnMore: "Saber Más"
      },
      features: {
        ...
        feature1: {
          ...
          description: "Aplicaciones ultrarrápidas con rendimiento optimizado y carga instantánea"
        },
        feature2: {
          title: "Fácil de Usar",
          description: "Interfaz intuitiva diseñada para desarrolladores de todos los niveles"
        },
        feature3: {
          title: "Escalable",
          description: "Construye aplicaciones que crecen con las necesidades de tu negocio"
        },
        feature4: {
          title: "Seguro",
          description: "Seguridad de nivel empresarial integrada en cada componente"
        }
      },
      testimonials: {
        title: "Lo Que Dicen Nuestros Usuarios",
        testimonial1: {
          quote: "Esta plataforma transformó cómo construimos aplicaciones. ¡La velocidad y confiabilidad son excepcionales!",
          author: "Sarah Johnson",
          role: "Desarrolladora Principal en TechCorp"
        },
        testimonial2: {
          quote: "La mejor experiencia de desarrollo que he tenido. Todo funciona sin problemas.",
          author: "Miguel Rodriguez",
          role: "Desarrollador Full Stack"
        },
        testimonial3: {
          quote: "La productividad de nuestro equipo aumentó un 300% después de cambiar a esta plataforma.",
          author: "Emma Chen",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300">
              Test the internationalization features below
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-700 p-6 rounded-lg border border-gray-600">
              <h3 className="text-xl font-semibold mb-4 text-white">🌍 Language Testing</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">Hero Title:</span>
                  <span className="font-medium text-white">{t.hero.title}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">CTA Button:</span>
                  <span className="font-medium text-white">{t.hero.cta}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">Features Title:</span>
                  <span className="font-medium text-white">{t.features.title}</span>
                </div>
              </div>
            </div>
            ...
            {/* Interactive Testing */}
            <div className="bg-gray-700 p-6 rounded-lg border border-gray-600">
              <h3 className="text-xl font-semibold mb-4 text-white">🎮 Interactive Testing</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">Current Language:</span>
                  <span className="font-mono text-sm bg-gray-600 text-blue-300 px-2 py-1 rounded">
